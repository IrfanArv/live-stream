...
class Quiz extends CI_Controller
{
    ...
    function index()
    {
        if ($this->data['isadmin']) {
            $this->data['pagetitle'] = 'Quiz - Webly';
            $this->backend->display('backend/modules/quizV', $this->data);
        } else {
    ...
    public function quizList()
    {
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->QuizM->count_all(),
            "recordsFiltered" => $this->QuizM->count_filtered(),
            "data" => $data,
        );
    ...
    public function linkEdit()
    {
        ...
        $this->QuizM->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }

    public function linkDelete($id)
    {
        $this->QuizM->delete_by_id($id);
        echo json_encode(array("status" => TRUE));
    }
