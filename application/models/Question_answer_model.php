...
class Question_answer_model extends CI_Model
{
	...
	//*== Get data ==*/  
	function get_last_question($user_id = '', $trivia_id = '')
	{
		$this->db->select("a.*");
		$this->db->where("user_id = $user_id");
		$this->db->where("trivia_id = $trivia_id");
	...
	//*== Get data ==*/  
	function get_total_success($user_id = '', $trivia_id = '')
	{
		// $this->db->select("count(point_total) as total");
		// $this->db->where("user_id = $user_id");
		// $this->db->where("trivia_id = $trivia_id");
		...
		$this->db->select_sum('point_total');
		$this->db->from($this->table_name);
		$this->db->where("user_id = $user_id");
		$this->db->where("trivia_id = $trivia_id");
		$query = $this->db->get();
		return $query->row()->point_total;
	}
